<?php
    ...
    //Cria o cliente através dos dos POSTS passados pelo 'editCliente.html'
    ...
    //Edita o cliente no banco de dados através do id do cliente passado por POST
    $mysql->editClientById($_POST['id_cli'],$cliente);
